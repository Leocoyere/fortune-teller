...
export default function AnimatedInput() {
	...
	return (
    	<div className="mb-20 relative z-1 flex justify-center items-center gap-4 border-b-2 border-white pb-2">
			{ animate ?
			...
			<input className="text-white nohemi w-lg" type="text" onFocus={() => setAnimate(false)} onBlur={(e) => handleSetAnimate(e)} />
