...
export default function AnimatedInput() {
	...
	return (
    	<div className="mb-20 mt-10 lg:mt-auto px-5 w-full sm:w-auto relative z-1 flex justify-center items-center gap-4">
			{ animate ?
			...
			<input className="relative text-white nohemi w-full sm:w-sm lg:w-lg border-b-2 border-white" type="text" onFocus={() => setAnimate(false)} onBlur={(e) => handleSetAnimate(e)} />
